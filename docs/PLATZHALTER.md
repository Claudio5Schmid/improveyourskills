...
| **T11** | Eckdaten Startseite (`home_facts`)                          | ✅ Anzeige fertig (UI-Pass Aug 2026) — Abschnitt bleibt unsichtbar, bis mindestens ein Eckdatum sichtbar erfasst ist                                                                                                                                                                     | Termin, Ort, Alter/Kategorie, Kosten, Anmeldung usw., im Admin unter „Eckdaten" erfassen                |
