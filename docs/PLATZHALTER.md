...
| **B9** | **Feature-Boxen Über uns** (3 ×) | ❌ nur Emoji 🎯 👥 🏆 | Optional Bilder statt Emoji (Briefing Phase 6.4) | 6 |
| **B10** | **Banner zwischen Sektionen** | ❌ existiert nicht | Vollbreites Bild (Briefing Phase 6.4) | 6 |
...
| **T9** | Zahlen (`stats`) | ❌ existieren nicht | z. B. Anzahl Teilnehmende, Trainingstage, Nationalspieler:innen |
