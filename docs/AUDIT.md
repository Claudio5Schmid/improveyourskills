...
| Hero             | Badge           | `Skill Training 2026` _(CSS macht daraus Grossbuchstaben)_                                                                                                                                                                  |
|                  | Titel           | `Improve` / `your` _(nur Outline)_ / `skills.`                                                                                                                                                                              |
...
|              | Titel              | `Kontakt.` _(kein Untertitel)_                                                                                  |
...
|  **670 KB** | 1920 × 1280 | ✅         | `54923280127_69f6204584_k.jpg`                                          | Hero-Slide 3 _(liegt im Wurzelverzeichnis)_ |
...
|  **185 KB** | 1600 × 900  | ❌         | `Bilder/Symboldbild_Unihockey.jpg`                                      | _(war früher „Was wir anbieten")_           |
...
| `bilder/logo.png` _(klein geschrieben)_ | `impressum.html:16`                                   | Zusätzlicher Schreibfehler — würde auch dann scheitern, wenn das Logo existierte, weil GitHub Pages Gross-/Kleinschreibung unterscheidet.                                             |
...
Im Briefing steht: _„sie sind, soweit ich weiss, rein per CSS gestylt, ohne externen
Font-Dienst — bitte bestätigen"_.
...
| ------------------------------------------------- | --------------------------------------------------------- |
| `index.html`, `impressionen.html`, `kontakt.html` | _(fehlt komplett)_                                        |
